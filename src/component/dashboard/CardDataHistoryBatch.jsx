...
const CardDataHistoryBatch = ({seticon ,headerFilter , title }) => {
  const { data_batch , historicalData} = useContext(BatchStatusContext);
...
export default CardDataHistoryBatch